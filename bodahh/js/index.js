...
const cargarDatos = async (code) => {
    const respuesta = await fetch(`http://74.208.187.67:8080/wedding/v1/personamesa/search?code=${code}`)
...
function saveRow(data) {
    fetch("http://74.208.187.67:8080/wedding/v1/personamesa/confirm", {
        method: "post",
