...
const cargarDatos = async (code) => {
    const respuesta = await fetch(`https://74.208.187.67:8443/wedding/v1/personamesa/search?code=${code}`)
...
function saveRow(data) {
    fetch("https://74.208.187.67:8443/wedding/v1/personamesa/confirm", {
        method: "post",
